...
export default function EvaluatorTeams() {
    ...
    queryFn: async () => {
      try {
        const res = await axiosPrivate.get(
          `evaluator/projects/${projectId}/teams`
        );
        return res.data;
      } catch (error) {
        return error;
      ...
      <div
        ...
        onClick={() => {
          if (submissionType === "singleSubmission") {
            navigate(
              `/evaluator/projects/${projectId}/teams/${team.teamId}/single-sub`
            );
          } else if (submissionType === "milestoneSubmission") {
            navigate(
              `/evaluator/projects/${projectId}/teams/${team.teamId}/milestone`
            );
          }
        }}
        className='card mb-2'
